...
class OrangeAdminTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_orange_admin(self):
        ...
        nb_employes = driver.find_elements(By.XPATH, "//div[@class='oxd-table-card']")
        print(len(nb_employes))
        
        driver.find_element(By.LINK_TEXT,"Logout").click()
        driver.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login")
        
        assert len(nb_employes) == 4, "Le nombre d'éléments dans le panier n'est pas égal à 4"
